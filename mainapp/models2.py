...
class Additional_dates(models.Model):
    id_label = models.CharField(null=True,max_length=20, verbose_name="Идентификационная метка")
...
class Catch_info(models.Model):
    act_of_adm = models.CharField(null=True,max_length=20, verbose_name="Акт о поступлении животного №")
...
class Ecto_endo_info(models.Model):
    ecto_no_p_p = models.IntegerField(null=True, verbose_name="№ п/п")
...
class Vaccination(models.Model):
    vac_no_p_p = models.IntegerField(null=True, verbose_name="№ п/п")
